...
const LocxyMemory = (() => {
  const KEYS = {
    facts: 'locxy_facts_v1',
    sessions: 'locxy_sessions_v1',
    activeId: 'locxy_active_session_v1',
    prefs: 'locxy_prefs_v1',
    profile: 'locxy_profile_v1',
  };
   ...
   * LocxyModels.chat, passed in to avoid a circular module dependency.
   */
